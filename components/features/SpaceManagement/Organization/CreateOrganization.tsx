                ...
                <div className={className}>
                    {
                        ...
                        <div className="card">
                            <div className="card-body p-7">
                                ...
                                {
                                    currentStep === 1 ? <AddOrgGeneral organization={props.organization} key={1} submittedCallback={onSubmitOrganization} changeStep={changeStepHandler}></AddOrgGeneral> : <Facilities key={2} orgId={organization?.orgId} onClose={props.close} changeStep={changeStepHandler} ></Facilities>
                                }
                            </div>
                        </div>
                    }
