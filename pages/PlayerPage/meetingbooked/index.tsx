...
export default function MeetingBooked() {
  return (
    <div className={`min-h-[700px] h-screen max-h-screen w-screen p-4 box-border bg-cover `} style={{backgroundImage: `url(./booked.jpg)`}}>
    <div className={`w-full h-full`}>
        <div className={`w-full h-full flex flex-col bg-white/25 rounded-[40px]`}>
